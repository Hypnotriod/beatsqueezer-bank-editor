...
public class RawPCMDataPlayer 
{
    ...
    public static synchronized void play(AudioInputStream audioInputStream, int loopStart, int loopEnd, float pan, LineListener lineListener) throws IOException, LineUnavailableException
    {
        stop();
